...
This project is an implementation of the shell created as the final project for the C programming.
...
```
https://github.com/McGavin20/simple_shell.git.
```
...
* [**Sharma Muridzo**](https://github.com/McGavin20)
* [**Leo Kapfudzarura**](https://github.com/leokapsy)
